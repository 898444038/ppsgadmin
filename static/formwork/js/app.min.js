...
$(document).ready(function () {
    ...
    if ($("#widget-calendar-body")[0]) {
        ...
        (i = new FullCalendar.Calendar(t, {
            ...
            events: [{title: "Dolor Pellentesque", start: "2020-08-01"}, {
                title: "Purus Nibh",
                start: "2020-08-07"
            }, {title: "Amet Condimentum", start: "2020-08-09"}, {
                title: "Tellus",
                start: "2020-08-12"
            }, {title: "Vestibulum", start: "2020-08-18"}, {
                title: "Ipsum",
                start: "2020-08-24"
            }, {title: "Fringilla Sit", start: "2020-08-27"}, {
                title: "Amet Pharetra",
                url: "http://google.com/",
                start: "2020-08-30"
            }]
    ...
    if ($("#calendar")[0]) {
        ...
        var a, o, i, l = document.getElementById("calendar-title"), n = (e = new Date).getMonth(), r = e.getFullYear(),
            s = [{
                id: 1,
            ...
            }, {id: 3, title: "Egestas Justo", start: new Date(r, n, 18), allDay: !0, description: ""}, {
                id: 4,
            ...
            }, {id: 8, title: "Egestas", start: new Date(r, n, 5), allDay: !0, description: ""}, {
                id: 9,
                title: "Purus",
                start: new Date(r, n, 1),
                allDay: !0,
            ...
            }, {id: 12, title: "Porta Ornare Euismod", start: new Date(r, n, 30), allDay: !0, description: ""}, {
                id: 13,
        ...
        (i = new FullCalendar.Calendar(t, {
            ...
            var e = $(".event-new__title"), t = $(".event-new__title").val(), a = o;
            ...
            var e = $(".event-edit__title"), t = $(".event-edit__title").val();
    ...
    if ($(".input-slider")[0])for (var o = document.getElementsByClassName("input-slider"), i = 0; i < o.length; i++)noUiSlider.create(o[i], {
        start: [20],
        connect: "lower",
        range: {min: 0, max: 100}
    })
    ...
    $(".flot-curved-line")[0] && $.plot($(".flot-curved-line"), [{
        ...
        lines: {
            ...
            lineWidth: 0,
            fill: 1,
            fillColor: {colors: ["rgba(255,255,255,0.0)", "rgba(255,255,255,0.1)"]}
        },
        ...
        label: "Data",
        stack: !0,
        lines: {show: !0, lineWidth: 0, fill: 1, fillColor: {colors: ["rgba(255,255,255,0)", "rgba(255,255,255,0.3)"]}},
        data: [[10, 90], [20, 40], [30, 80], [40, 20], [50, 90], [60, 20], [70, 60]]
    }], {
        series: {
            shadowSize: 0,
        ...
        stack: !0,
        color: "#fff",
        lines: {show: !0, fill: 1, fillColor: {colors: ["rgba(255,255,255,0)", "rgba(255,255,255,0.35)"]}},
    ...
    if ($(".flot-dynamic")[0]) {
        var o = [], i = 300, a = $.plot(".flot-dynamic", [t()], {
            series: {
